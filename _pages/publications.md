...
<div class="pub-entry">
  <div class="pub-title">
    <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6455601" target="_blank" rel="noopener">Does Bank AI Adoption Benefit Consumers? Evidence from Consumer Complaints</a>
  </div>
  <div class="pub-status">Job Market Paper, Sole-Authored</div>
  <p class="pub-abstract"><strong>Abstract:</strong> We provide the first large-scale evidence on whether technological gains from bank artificial intelligence (AI) adoption translate into better outcomes for consumers. Using CFPB complaint data (2010–2023), we construct a bank-county-quarter panel linking consumer complaints to bank-level AI patent filings and find that AI adoption reduces complaint rates by approximately 30 percent relative to the sample mean. The result is robust to an alternative measure based on banks' AI employee share. Event-study estimates show parallel pre-trends and a two-year lag in complaint reductions; propensity score matching and a Bartik-style instrument further corroborate a causal interpretation. These gains vary across financial services and banks. AI reduces complaints in transaction processing and credit reporting by eliminating sources of operational errors while generating new grievances through opaque algorithmic decisions and rigid automation in credit and customer service. AI adoption also improves complaint resolution and reduces consumer-perceived discrimination.</p>
...
<div class="pub-entry">
  ...
  <div class="pub-conf"><strong>Presentations:</strong> 2026 FMA, EUROFIDAI-ESSEC Paris, FHC Silicon Valley 2026, EasternFA 2026, 3rd AI in Finance, University of South Carolina</div>
</div>
